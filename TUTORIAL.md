...
is named "finaglezk", there should be a `finaglezk.log` with contents like this:
...
The IDL for your service is in `src/main/thrift/finaglezk.thrift`.  The
...
In `src/main/scala`, take a look at `FinaglezkServiceImpl.scala`. (This may
...
src/test/scala/com/twitter/finaglezk/FinaglezkServiceSpec.scala.  Check
